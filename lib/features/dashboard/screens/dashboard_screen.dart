...
import 'package:sixam_mart/features/home/screens/categories_screen.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    _screens = [
      ...
      const SizedBox(), // Cart placeholder
      const OrderScreen(),
      const MenuScreen()
    ];
                          ...
                          child: GetBuilder<SplashController>(
                              builder: (splashController) {
                                ...
                                _screens = [
                                  const HomeScreen(),
                                  const CategoriesScreen(),
                                  // const FavouriteScreen(), // Category
                                  const SizedBox(), // Cart
                                  const OrderScreen(),
                                  const MenuScreen() // Account
                                ];
                                return SafeArea(
                                  top: false,
                                  child: Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      color: Color(0xFF118242), // Green background for bottom nav
                                      ...
                                      ResponsiveHelper.isDesktop(context) ? const SizedBox() : (widget.fromSplash && Get.find<LocationController>().showLocationSuggestion && active) ? const SizedBox()
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                            ...
                                            BottomNavItemWidget(
                                              title: isParcel ? 'address'.tr : 'categories'.tr,
                                            ...
                                            BottomNavItemWidget(
                                              title: '',
                                              selectedIcon: Images.shoppingCart,
                                            ...
                                            BottomNavItemWidget(
                                              title: 'Account'.tr, selectedIcon: Images.menu, unSelectedIcon: Images.menu,
